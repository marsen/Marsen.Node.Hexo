---
title: "[實作筆記] 個人自動化平台(五) n8n 實作：讀層，Aggregate + Gemini 週報整理"
...
取層跑通後，每次執行輸出統一格式的文章列表。這篇記錄讀層：把多筆文章合併，送給 Gemini 整理成 AI 週報。
...
- [個人自動化平台(四) n8n 實作：取層，RSS 資料來源](/2026/n8n-5-pipeline-fetch/)

## 小結

- Aggregate 節點把多筆合成一筆，是讀層的關鍵，解決 rate limit 也符合週報語意
