...
在 [個人自動化平台(六)](/2026/n8n-6-pipeline-output/) 實作 IG Token 工具時，為了修 Instagram OAuth callback URL 的問題，在 Vercel 設了 `NEXT_PUBLIC_BASE_URL`。
...
這個字串不可能通過 Google 驗證。但 production 上從來沒有人測試過 Google 登入，所以一直沒被發現。
